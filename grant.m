...
init2 = [0, 0, -1800, 0, 0.0278, 0, 20.99, 0, 0.5837, 0, 0, 0];
aircraft_surfaces2 = [0.1079;0;0;.3182];
...
[t2, x2] = ode45(@(t2,x2) GrantsAircraftEOM(t2,x2,aircraft_surfaces2,wind_inertial,aircraft_parameters),tspan,init2');
for i=1:length(t2)
    airsurface2(:,i) = aircraft_surfaces2;
end
PlotAircraftSim(t2,x2',airsurface2,7:1:12)
