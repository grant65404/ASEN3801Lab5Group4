function [var_dot] = GrantsAircraftEOMDoublet(time, aircraft_state, aircraft_surfaces, doublet_size, doublet_time, wind_inertial, density, aircraft_parameters)
...
if time<=doublet_time
    sigma_elevator = sigma_elevator +doublet_size;
