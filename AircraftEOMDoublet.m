function [var_dot] = AircraftEOMDoublet(time, aircraft_state, aircraft_surfaces, doublet_size,doublet_time, wind_inertial, density, aircraft_parameters)
...
[aero_forces, aero_moments] = AeroForcesAndMoments(aircraft_state, ElevatorChange(aircraft_surfaces,doublet_time,doublet_size, time), wind_inertial, density, aircraft_parameters);
