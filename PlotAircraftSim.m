...
subplot(2,2,1);
plot(time,control_input_array(1,:), col, linewidth=1.3); hold on;
title("Elevator")
xlabel("time (s)");
ylabel("\delta_e (deg)");
subplot(2,2,2);
plot(time,control_input_array(2,:), col, linewidth=1.3); hold on;
title("Aileron")
xlabel("time (s)");
ylabel("\delta_a (deg)");
subplot(2,2,3);
plot(time,control_input_array(3,:), col, linewidth=1.3); hold on;
title("Rudder")
xlabel("time (s)");
ylabel("\delta_r (deg)");
subplot(2,2,4);
...
figure(fig(6));
plot3(aircraft_state_array(1,:),aircraft_state_array(2,:),-aircraft_state_array(3,:), col, linewidth=1.3); hold on
